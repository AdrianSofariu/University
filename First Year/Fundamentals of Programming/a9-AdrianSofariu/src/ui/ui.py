...
from src.domain.errors import InputError, BusinessLogicError, UndoRedoError
...
class UI:
    ...
    def __init__(self, students: Repository(), assignments: Repository(), grades: Repository()):
        self._undo_service = UndoService()
        self._grade_service = GradeService(students, assignments, grades, self._undo_service)
        self._student_service = StudentService(students, self._grade_service, self._undo_service)
        self._assignment_service = AssignmentService(assignments, self._grade_service, self._undo_service)
        self._student_service.init_repo()
        self._assignment_service.init_repo()
        self._grade_service.init_repo()
    ...
    def start(self):
        ...
        while True:
            ...
            try:
                command = input(">>")
                UI.validate_command(command, 9)
                self.execute_command(int(command))
            except (RepositoryError, InputError, ValueError, TypeError, BusinessLogicError, UndoRedoError) as e:
    ...
    def add_student(self):
        ...
        self._student_service.add_student(identifier, name, group)
    ...
    def remove_student(self):
        ...
        self._student_service.remove_student(identifier)
    ...
    def update_student(self):
        ...
        self._student_service.update_student(identifier, name, group)
    ...
    def add_assignment(self):
        ...
        self._assignment_service.add_assignment(identifier, desc, d)
    ...
    def remove_assignment(self):
        ...
        self._assignment_service.remove_assignment(identifier)
    ...
    def update_assignment(self):
        ...
        day = int(input('Enter a day: '))
        d = date(year, month, day)
        self._assignment_service.update_assignment(identifier, desc, d)
    ...
    def give_assignment_student(self):
        ...
        self._grade_service.add_grade(student, assignment, -1)
    ...
    def give_assignment_group(self):
        ...
        assignment = int(input("Enter assignment ID: "))
        self._grade_service.add_grade_for_group(group, assignment)
    ...
    def grade_assignment(self):
        ...
        """
        student = int(input("Enter student ID: "))
        ungraded_assignments = self._grade_service.ungraded_assignments(student)
        ...
        self._grade_service.grade_student(student, assignment, grade)
    ...
    def students_with_assignment(self):
        ...
        assignment, students = self._grade_service.assignment_given(assignment_id)
    ...
    def late_students(self):
        ...
        result = self._grade_service.late_assignment()
    ...
    def school_situation(self):
        ...
        :return:
        """
        result = self._grade_service.school_situation()
    ...
    def print_grades(self):
        ...
        :return:
        """
        result = self._grade_service.list_grades()
        for grade in result:
            print(grade)